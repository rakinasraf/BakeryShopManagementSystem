...
namespace OOP2FinalProject
{
    public partial class CardPayment : Form
    {
        ...
        public CardPayment(string id,string totalAmount)
        {
            InitializeComponent();
        ...
        private void CardPayment_FormClosed(object sender, FormClosedEventArgs e)
        {
            this.Close();
        }

        private void btnPervioustopayment_Click(object sender, EventArgs e)
        {
